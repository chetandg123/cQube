...
class Mahisagar_test(unittest.TestCase):
    ...
    def test_clusterbtn(self):
        ...
        time.sleep(5)
        self.driver.find_element_by_xpath("/html/body/app-root/app-home/mat-sidenav-container/mat-sidenav-content/div/app-sem-view/div/div[2]/div[2]/select[1]/option[20]").click()
        time.sleep(2)

...
class Schools_validation(unittest.TestCase):
    ...
    def test_validate_schoolrecords(self):
        ...
        clu = self.driver.find_element_by_xpath("//select[@name='myCluster']/option[contains(text(),'Jali')]").click()
        time.sleep(5)
        ...
        time.sleep(20)
        with open("/home/chetan/Documents/Data_files/Schools_Per_Cluster_report (3).csv", 'r') as file:

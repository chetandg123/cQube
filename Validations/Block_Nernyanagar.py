...
class Schools_validation(unittest.TestCase):
    ...
    def test_validate_schoolrecords(self):
        ...
        self.driver.find_element_by_xpath("//select[@name='myCluster']/option[contains(text(),'Nirnaynagar')]").click()
        ...
        with open("/home/chetan/Documents/Data_files/Schools_Per_Cluster_report (4).csv'", 'r') as file:

...
class Crc_Reports(unittest.TestCase):
    ...
    def test_crcclick(self):
        ...
        print(self.driver.find_element_by_xpath("//*[@id='select']/select/option[3]").text)
        time.sleep(5)
        # self.driver.find_element_by_xpath(Data.Download).click()
        # time.sleep(5)
        self.driver.find_element_by_xpath("//*[@id='select']/select/option[4]").click()
        print(self.driver.find_element_by_xpath("//*[@id='select']/select/option[4]").text)
        time.sleep(5)
        # self.driver.find_element_by_xpath(Data.Download).click()
        # time.sleep(5)
        self.driver.find_element_by_xpath("//*[@id='select']/select/option[5]").click()
        print(self.driver.find_element_by_xpath("//*[@id='select']/select/option[5]").text)
        time.sleep(5)
        # self.driver.find_element_by_xpath(Data.Download).click()
        # time.sleep(5)

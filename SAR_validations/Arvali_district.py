...
class District_Arvalli(unittest.TestCase):
    ...
    def test_validate_schoolrecords(self):
        dist = self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[contains(text(),'Aravalli')]").click()
        blk = self.driver.find_element_by_xpath("//select[@name='myBlock']/option[contains(text(),'Malpur')]").click()
        ...
        with open('/home/chetan/Documents/Data_files/Schools_Per_Cluster_report (11).csv', 'r') as file:

...
class Choose9(unittest.TestCase):
    ...
    def test_start(self):
        ...
        dist = self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[9]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[9]").text)

        blk = self.driver.find_element_by_xpath("//select[@name='myBlock']/option[4]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myBlock']/option[4]").text)
        clus= self.driver.find_element_by_xpath("//select[@name='myCluster']/option[3]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myCluster']/option[3]").text)

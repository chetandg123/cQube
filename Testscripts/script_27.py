...
class Choose12(unittest.TestCase):
    ...
    def test_start(self):
        ...
        dist = self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[12]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[12]").text)

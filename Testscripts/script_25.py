...
class Choose10(unittest.TestCase):
    ...
    def test_start(self):
        ...
        dist = self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[10]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[10]").text)

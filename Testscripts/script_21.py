...
class Choose6(unittest.TestCase):
    ...
    def test_start(self):
        ...
        dist = self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[6]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[6]").text)

        blk = self.driver.find_element_by_xpath("//select[@name='myBlock']/option[6]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myBlock']/option[6]").text)
        clus= self.driver.find_element_by_xpath("//select[@name='myCluster']/option[6]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myCluster']/option[6]").text)

...
class Choose5(unittest.TestCase):
    ...
    def test_start5(self):
        ...
        dist = self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[5]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[5]").text)

        blk = self.driver.find_element_by_xpath("//select[@name='myBlock']/option[5]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myBlock']/option[5]").text)
        clus= self.driver.find_element_by_xpath("//select[@name='myCluster']/option[5]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myCluster']/option[5]").text)

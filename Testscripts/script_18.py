...
class Choose1(unittest.TestCase):
    ...
    def test_start1(self):
        ...
        dist = self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[1]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[1]").text)
        ...
        clus= self.driver.find_element_by_xpath("//select[@name='myCluster']/option[1]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myCluster']/option[1]").text)

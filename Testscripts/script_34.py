...
class Choose19(unittest.TestCase):
    ...
    def test_start(self):
        ...
        dist = self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[19]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[19]").text)

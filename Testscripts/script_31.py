...
class Choose16(unittest.TestCase):
    ...
    def test_start(self):
        ...
        dist = self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[16]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[16]").text)

        blk = self.driver.find_element_by_xpath("//select[@name='myBlock']/option[1]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myBlock']/option[1]").text)
        clus= self.driver.find_element_by_xpath("//select[@name='myCluster']/option[4]").click()
        print(self.driver.find_element_by_xpath("//select[@name='myCluster']/option[4]").text)

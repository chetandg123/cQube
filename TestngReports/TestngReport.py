...
class MyTestSuite(unittest.TestCase):
    ...
    def test_Issue(self, script_39=None):
        ...
        smoke_test.addTests([
            ...
            # unittest.defaultTestLoader.loadTestsFromTestCase(script_38.Clusters),
            # unittest.defaultTestLoader.loadTestsFromTestCase(script_39.Clusters),
            # unittest.defaultTestLoader.loadTestsFromTestCase(script_40.Clusters),

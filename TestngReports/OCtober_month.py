...
from Monthwise_validations.October_validations import AMH_schoollevel, Amreli_district, Block_Halvad, Block_memnagar, \
...
class MyTestSuite(unittest.TestCase):
    ...
    def test_Issue(self):
        ...
        outfile = open("/home/chetan/PycharmProjects/cQube/Report/October_validation.html", "w")

        runner1 = HTMLTestRunner.HTMLTestRunner(
            stream=outfile,
            title='Test Report',
            verbosity = 1,
            description='Integration Testing of October month'

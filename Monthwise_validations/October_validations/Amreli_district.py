...
class Schools_validation(unittest.TestCase):
    ...
    def test_validate_schoolrecords(self):
        ...
        time.sleep(5)
        self.driver.find_element_by_xpath("//select[@name='myDistrict']/option[contains(text(),' Amreli ')]").click()
        time.sleep(2)
        self.driver.find_element_by_xpath("//select[@name='myBlock']/option[contains(text(),' Amreli ')]").click()
        ...
        time.sleep(20)
        with open("/home/chetan/Documents/Data_files/Cluster_per_block_report (3).csv", 'r') as file:

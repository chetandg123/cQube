...
class Schools_validation(unittest.TestCase):
    ...
    def test_validate_schoolrecords(self):
        ...
        blk = self.driver.find_element_by_xpath("//select[@name='myBlock']/option[contains(text(),'Amreli')]").click()
        clu = self.driver.find_element_by_xpath("//select[@name='myCluster']/option[contains(text(),'Vankiya')]").click()
        time.sleep(5)
        ...
        time.sleep(20)
        with open("/home/chetan/Documents/Data_files/Schools_Per_Cluster_report (5).csv", 'r') as file:
